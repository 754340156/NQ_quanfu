...
- (void)drawRect:(CGRect)rect {
    UIImage *norImage = Image(@"xingji_an");
    UIImage *selImage = Image(@"xingji_liang");
    // 图片没间隙自己画
