...
@interface FirstClassVC ()

@end

@implementation FirstClassVC
...
{
    [super configParams];
    self.listArray = @[@"服饰内衣",@"母婴",@"运动户外",@"珠宝首饰",@"家具假装",@"宠物生活",@"玩具乐器",@"汽车用品",@"食品饮料",@"鞋靴"].mutableCopy;
...
{
    SecondClassVC * VC = [[SecondClassVC alloc] init];
    VC.firstClass = self.listArray[indexPath.row];
